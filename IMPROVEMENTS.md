...
- [ ] **1.1 Transparencia total en `runBatchPipeline` (Cero fallos silenciosos)**
...
- [ ] **1.2 Respetar `userConfig.thumbnail` en `parseOptions`**
...
- [ ] **1.3 Blindaje de procesos en Windows (`cmd.exe`)**
...
- [ ] **2.1 Despacho inteligente de argumentos (Smart CLI Routing)**
...
- [ ] **2.2 Modo interactivo continuo (`guidedMode`)**
...
- [ ] **3.1 Subcarpetas automáticas y numeración de pistas para álbumes**
...
- [ ] **3.2 Prevención de colisiones de nombres**
...
- [ ] **4.1 Soporte de Cookies contra verificaciones de bot en YouTube**
